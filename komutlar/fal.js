...
var nene = Math.floor(Math.random()*ne.length);
const gökmen = new Discord.MessageEmbed()
.setDescription(`${ne[nene]}`)
.setColor("BLACK")
.setTimestamp()
message.channel.send(gökmen)
};
exports.conf = {
enabled: true,
guildOnly: false,
